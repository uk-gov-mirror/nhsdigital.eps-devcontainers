...
These are all changed to not run anything and will be removed in a future release
- `trivy-license-check`
- `trivy-generate-sbom`
- `trivy-scan-python`
- `trivy-scan-node`
...
For each pull request, and merge to main, images are built, and pushed to GitHub Container Registry.      
